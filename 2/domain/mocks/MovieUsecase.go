...
func (_m *MovieUsecase) GetByID(ctx context.Context, ImdbID string) (domain.Movie, error) {
...
// Search ...
func (_m *MovieUsecase) Search(ctx context.Context, pagination int64, searchword string) (domain.Movies, error) {
